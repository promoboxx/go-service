...
func (a asyncDatadogClient) InternalCustom(originatingService, path, customName string, other map[string]string, value int64) error {
	go func() {
		err := a.dmc.InternalCustom(originatingService, path, customName, other, value)
