...
func (dmc *datadogMetricsClient) InternalCustom(originatingService, path, customName string, other map[string]string, value int64) error {
	metricTag := []string{"originating_service:" + originatingService, "path:" + path, "custom_name:" + customName}
